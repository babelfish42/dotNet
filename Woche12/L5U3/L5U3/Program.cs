...
namespace LinqOverCustomObjects
{
    ...
    class Program
    {
        ...
        static void GetFastCars(List<Car> myCars)
        {
            ...
            // greater than 55.
            // from c in myCars where c.Speed > 55 select c;
            var fastCars = myCars.Where(c => c.Speed > 55).Select(c => c); 
        ...
        static void GetFastBMWs(List<Car> myCars)
        {
            ...
            var fastCars = myCars.Where(c => c.Speed > 90 && c.Make == "BMW").Select(c => c); 
